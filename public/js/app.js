...
var render = function() {
  ...
  return _c("div", { staticClass: "form-group row" }, [
    _c(
      "label",
      { staticClass: "control-label col-sm-2", attrs: { for: "author_id" } },
      [_vm._v("Post As:")]
    ),
    _vm._v(" "),
      ...
      _c(
        "select",
        {
          ...
          on: {
            change: function($event) {
              ...
              _vm.author_id = $event.target.multiple
                ? $$selectedVal
                : $$selectedVal[0]
            }
          }
        ...
        [
          _vm._l(_vm.characters, function(character) {
            return _vm.characters.length
              ? _c("option", { domProps: { value: character.id } }, [
                  _vm._v(
                    "\n                " +
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      [_c("strong", [_vm._v("Mark All As Read")])]
    )
  },
  function() {
    var _vm = this
