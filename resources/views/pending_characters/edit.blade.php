                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 d-flex">
                                <input type="text"
                                       ...
                                       name="first_name"
                                       id="first_name"
                                       value="{{ $pending_character->first_name }}"
                                       required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text"
                                       ...
                                       name="chosen_name"
                                       id="chosen_name"
                                       value="{{ $pending_character->chosen_name }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text"
                                       ...
                                       name="last_name"
                                       id="last_name"
                                       value="{{ $pending_character->last_name }}"
                                       required>
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="origin_faction" id="origin_faction" required>
                                    ...
                                    @foreach($factions as $faction)
                                        @if($pending_character->origin_faction_id === $faction->id)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="faction" id="faction">
                                    <option selected disabled>Please Choose One</option>
                                    @foreach($factions as $faction)
                                        @if($pending_character->faction_id === $faction->id)
                                            <option value="{{ $faction->id }}" selected>{{ $faction->name }}</option>
                                        @else
                                            <option value="{{ $faction->id }}">{{ $faction->name }}</option>
                                        @endif
