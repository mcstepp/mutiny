...
@section('content')
    ...
    <div class="container-fluid my-3">
        ...
        <div class="row">
            <h1 class="h2 page-title m-fancy-header neon-default">All Pending Characters</h1>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="list-group m-card">
                        ...
                        @forelse($pending_characters as $pending_character)
                            <a href="{{ route('admin-show-pending-character', $pending_character) }}" class="list-group-item">
