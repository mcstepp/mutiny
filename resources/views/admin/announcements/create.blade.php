...
@section('content')
    ...
    @include('layouts._breadcrumb', ['menu' => [
        ...
        'link-route' => '#',
        'link-name' => 'Create Announcement'
        ]
    ]])

    <div class="container-fluid my-3">
        <div class="card m-card bg-industrial-">
            <h2 class="card-top m-fancy-title text-uppercase text-center">Create a New Announcement</h2>
            <hr class="glow-default mt-0">

            <div class="card-body container-fluid">
                <form method="POST"
                      action="{{ route('admin-store-announcement') }}"
